        ...
        <section className={stl.aboutSection}>
          ...
          <h3 className={stl.aboutTextBox}>
            <div className={stl.aboutText}>
              I am a Front-End developer looking for a remote part-time, full-time job with a flexible hours in a company that aims to make everyday
              life and business simpler, more productive and more user-friendly. I know PHP, MySql, JavaScript, HTML, CSS, Node.js and React well. In
              addition, I have practical experience using the Agile / Scrum methodology while working in a team. I learn quickly, responsibly and
              ready for difficult tasks.
            </div>
          </h3>
        </section>
        <section className={stl.aboutSection}>
          ...
          <div className={stl.aboutTextBox}>
            <ul className={stl.aboutList}>
              <li className={stl.aboutItem}>
                <a href="https://eventbooster.urko.tech" target="_blank" rel="noreferrer" className={stl.projectLink}>
                  EventBooster
                </a>
                [HTML, SASS, JS, Parcel]
                <p className={stl.projectInfo}>A website with a responsive layout</p>
              </li>
              <li className={stl.aboutItem}>
                <a href="https://icecream.urko.tech" target="_blank" rel="noreferrer" className={stl.projectLink}>
                  IceCream
                </a>
                [HTML, SASS, JS, Parcel]
                <p className={stl.projectInfo}>A website with a responsive layout</p>
              ...
              <li className={stl.aboutItem}>
                <a href="https://kapusta.urko.tech" target="_blank" rel="noreferrer" className={stl.projectLink}>
                  Kapusta
                </a>
                ...
                <div className={stl.aboutItemWork}>
                  ...
                  <p className={stl.work}>
                    ...
                    <ul className={stl.workTask}>
                      <li className={stl.taskItem}>website programming: html, css, js, php, mysql</li>
                    </ul>
                  </p>
                </div>
              </li>
              ...
              <li className={stl.aboutItem}>
                <div className={stl.aboutItemEducation}>
                  ...
                  <p className={stl.educationPlace}>
                    <span className={stl.university}>Taras Shevchenko National University of Kyiv</span>
                    <span className={stl.profession}>Master of Philosophy, specialty political science</span>
                  </p>
                </div>
              </li>
              <li className={`${stl.aboutItem} ${stl.aboutItemAdditional}`}>
                <div className={stl.additional}>
                  <h2 className={stl.additionalTitle}>
                    <span className={stl.additionalTitleName}>ADDITIONAL EDUCATION</span>
                  </h2>
                  <div className={stl.aboutTextBox}>
                    <ul className={stl.aboutListAdditional}>
                      <li className={stl.aboutItem}>
                        <div className={stl.aboutItemEducation}>
                          ...
                          <p className={stl.educationPlace}>
                            <span className={stl.university}>IT School GoIT (Kyiv)</span>
                            <span className={stl.profession}>Full Stack Developer</span>
                          </p>
                        </div>
                      </li>
                    </ul>
